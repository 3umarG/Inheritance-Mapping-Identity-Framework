...
{
    public partial class TablePerHierarchyMapping : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentsWithSubjects", x => new { x.StudentId, x.SubjectId });
                    table.ForeignKey(
                        name: "FK_StudentsWithSubjects_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentsWithSubjects_Subject_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentsWithSubjects_SubjectId",
                table: "StudentsWithSubjects",
                column: "SubjectId");
